...
var Notifications = class extends eventemitter3.EventEmitter {
  constructor(config) {
    super();
...
var DefaultWebSocketAdapter = class extends eventemitter3.EventEmitter {
...
function useNotifications(options = {}) {
  ...
  const markAsUnread = react.useCallback(async (id) => {
    try {
  ...
  const markAllAsRead = react.useCallback(async (category) => {
    try {
...
function NotificationDropdown({
  ...
  const [wsErrorLogged, setWsErrorLogged] = react.useState(false);
  ...
  const fetchNotifications = react.useCallback(async (pageNum = page) => {
    try {
      setLoading(true);
      setError(null);
      const params = new URLSearchParams();
  ...
  const goToPage = react.useCallback((pageNum) => {
    setPage(pageNum);
  ...
  const getPriorityAvatar = (priority) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("span", { className: `flex items-center justify-center rounded-full h-8 w-8 ${color.bg}`, children: Icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: `h-4 w-4 ${color.iconColor}` }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: `h-4 w-4 rounded ${color.iconColor.replace("text-", "bg-")}` }) });
  };
  ...
  const ButtonComponent = Button || ((props) => /* @__PURE__ */ jsxRuntime.jsx("button", { ...props }));
  const BadgeComponent = Badge || ((props) => /* @__PURE__ */ jsxRuntime.jsx("span", { ...props }));
  const DropdownMenuComponent = DropdownMenu || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  const DropdownMenuContentComponent = DropdownMenuContent || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  const DropdownMenuItemComponent = DropdownMenuItem || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  const DropdownMenuLabelComponent = DropdownMenuLabel || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  const DropdownMenuSeparatorComponent = DropdownMenuSeparator || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  const DropdownMenuTriggerComponent = DropdownMenuTrigger || ((props) => /* @__PURE__ */ jsxRuntime.jsx("button", { ...props }));
  const ScrollAreaComponent = ScrollArea || ((props) => /* @__PURE__ */ jsxRuntime.jsx("div", { ...props }));
  return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenuComponent, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuTriggerComponent, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
      ButtonComponent,
      {
        variant: "outline",
        size: "icon",
        ...
        children: [
          Icons?.bell ? /* @__PURE__ */ jsxRuntime.jsx(Icons.bell, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-5 w-5" }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sr-only", children: "Toggle notifications" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenuContentComponent, { align: "start", className: "w-80 p-0 shadow-xl rounded-xl", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "p-3 border-b flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuLabelComponent, { className: "text-base font-semibold pl-0", children: t.title }),
        unreadCount > 0 && /* @__PURE__ */ jsxRuntime.jsx(
          ButtonComponent,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ScrollAreaComponent, { className: "h-80", children: loading ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-center p-6", children: [
        Icons?.loader ? /* @__PURE__ */ jsxRuntime.jsx(Icons.loader, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-4 animate-spin bg-gray-300 rounded" }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ml-2 text-sm text-muted-foreground", children: t.loading })
      ] }) : notifications.length === 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center justify-center p-8 text-center", children: [
        Icons?.bell ? /* @__PURE__ */ jsxRuntime.jsx(Icons.bell, { className: "h-7 w-7 text-muted-foreground mb-2" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-7 w-7 bg-gray-300 rounded mb-2" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground", children: t.noNotifications }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-muted-foreground", children: t.allCaughtUp })
      ] }) : /* @__PURE__ */ jsxRuntime.jsx("div", { children: notifications.filter((notification) => notification && notification.id).map((notification) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex-shrink-0 mt-0.5", children: getPriorityAvatar(notification.meta?.priority || "normal") }),
                    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1", children: [
                        /* @__PURE__ */ jsxRuntime.jsx("span", { className: `font-semibold text-xs truncate max-w-[120px] ${isRead ? "text-muted-foreground" : "text-foreground"}`, title: getNotificationText(notification.title, getTranslationData(notification.data)), children: getNotificationText(notification.title, getTranslationData(notification.data)) }),
                        !isRead && /* @__PURE__ */ jsxRuntime.jsx("span", { className: `ml-1 h-1.5 w-1.5 rounded-full inline-block ${dotClass}` })
                      ] }),
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-xs text-muted-foreground mt-0.5 text-left line-clamp-1", children: stripMarkdown(getNotificationText(notification.body || notification.message, getTranslationData(notification.data))) }),
                        ...
                        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1", children: [
                          !isRead && /* @__PURE__ */ jsxRuntime.jsx(
                            ButtonComponent,
                            {
                              ...
                              title: t.markAsRead,
                              children: Icons?.check ? /* @__PURE__ */ jsxRuntime.jsx(Icons.check, { className: "h-3 w-3 text-green-600" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-3 bg-green-600 rounded" })
                            }
                          ),
                          hoveredId === notification.id && /* @__PURE__ */ jsxRuntime.jsx(
                            ButtonComponent,
                            {
                              variant: "ghost",
                              size: "icon",
                              ...
                              title: t.delete,
                              children: Icons?.x ? /* @__PURE__ */ jsxRuntime.jsx(Icons.x, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-3 bg-gray-400 rounded" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-5 w-5 flex items-center justify-center opacity-70", children: isExpanded ? Icons?.chevronUp ? /* @__PURE__ */ jsxRuntime.jsx(Icons.chevronUp, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-3 bg-gray-400 rounded" }) : Icons?.chevronDown ? /* @__PURE__ */ jsxRuntime.jsx(Icons.chevronDown, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-3 bg-gray-400 rounded" }) })
                        ] })
                      ] })
                    ] })
                  ]
              ...
              isExpanded && (() => {
                ...
                return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-3 pb-2", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "p-3 rounded-lg bg-gray-50/80 border border-gray-200 text-xs flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("div", { className: "font-semibold text-sm break-words", children: getNotificationText(notification.title) }),
                  /* @__PURE__ */ jsxRuntime.jsx("div", { className: "break-words whitespace-pre-line", children: stripMarkdown(getNotificationText(notification.body || notification.message)) }),
                  dataObj.adminNotes && dataObj.adminNotes.trim() !== "" && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-2 relative", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-2 p-3 bg-blue-50 border-l-4 border-blue-400 rounded-r-md", children: [
                    Icons?.quote ? /* @__PURE__ */ jsxRuntime.jsx(Icons.quote, { className: "h-4 w-4 text-blue-500 flex-shrink-0 mt-0.5" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-4 bg-blue-500 rounded flex-shrink-0 mt-0.5" }),
                    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-xs font-semibold text-blue-800 mb-1", children: "Admin notes:" }),
                      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-xs text-gray-700", children: dataObj.adminNotes })
                    ] }),
                    Icons?.quote ? /* @__PURE__ */ jsxRuntime.jsx(Icons.quote, { className: "h-4 w-4 text-blue-500 flex-shrink-0 mt-0.5 rotate-180" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-4 w-4 bg-blue-500 rounded flex-shrink-0 mt-0.5 rotate-180" })
                  ] }) }),
                  notification.data?.link && /* @__PURE__ */ jsxRuntime.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        Icons?.externalLink ? /* @__PURE__ */ jsxRuntime.jsx(Icons.externalLink, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-3 w-3 bg-blue-600 rounded" }),
                        " ",
                        t.viewMore
                      ]
                    }
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-t bg-white", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs text-muted-foreground", children: t.page.replace("{page}", page.toString()).replace("{pageCount}", totalPages.toString()) }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ButtonComponent,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuSeparatorComponent, {}),
      /* @__PURE__ */ jsxRuntime.jsx(
...
exports.DefaultWebSocketAdapter = DefaultWebSocketAdapter;
exports.InMemoryStorageAdapter = InMemoryStorageAdapter;
exports.NotificationClientSDK = NotificationClientSDK;
